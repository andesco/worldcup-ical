...
const ui = {
  en: ["Custom Calendar Subscription","source code","source data","Favourite teams","Filter teams…","Big games","both teams are ranked in the top","by odds of winning the tournament","all 32 knockout games","home openers of the 3 host nations","Competitive games","odds for each team winning the match are within","percentage points","Options","Language","show emoji flags","use FIFA three-letter country code","Your calendar subscription URL:","Copy URL","Subscribe","Example Matches in Feed","Select teams or enable a rule.","No matches yet for these settings.","Copied","increase","decrease"],
  es: ["Suscripción de calendario personalizada","código fuente","fuentes de datos","Equipos favoritos","Filtrar equipos…","Grandes partidos","ambos equipos están clasificados entre los primeros","por probabilidades de ganar el torneo","los 32 partidos eliminatorios","debut como local de los 3 países anfitriones","Partidos competitivos","las probabilidades de victoria de cada equipo difieren en","puntos porcentuales","Opciones","Idioma","mostrar banderas emoji","usar el código FIFA de tres letras","URL de suscripción a tu calendario:","Copiar URL","Suscribirse","Ejemplos de partidos del calendario","Selecciona equipos o activa una regla.","Todavía no hay partidos para esta configuración.","Copiado","aumentar","disminuir"],
  fr: ["Abonnement calendrier personnalisé","code source","sources de données","Équipes favorites","Filtrer les équipes…","Grands matchs","les deux équipes sont classées parmi les","selon leurs chances de gagner le tournoi","les 32 matchs à élimination directe","premier match à domicile des 3 pays hôtes","Matchs équilibrés","l’écart entre les chances de victoire des équipes est inférieur à","points de pourcentage","Options","Langue","afficher les drapeaux emoji","utiliser le code pays FIFA à trois lettres","URL d’abonnement à votre calendrier :","Copier l’URL","S’abonner","Exemples de matchs du calendrier","Sélectionnez des équipes ou activez une règle.","Aucun match pour ces paramètres pour le moment.","Copié","augmenter","diminuer"],
  "pt-PT": ["Subscrição de calendário personalizada","código-fonte","fontes de dados","Equipas favoritas","Filtrar equipas…","Grandes jogos","ambas as equipas estão classificadas entre as primeiras","pelas probabilidades de vencer o torneio","os 32 jogos a eliminar","estreias em casa dos 3 países anfitriões","Jogos equilibrados","as probabilidades de vitória de cada equipa diferem em","pontos percentuais","Opções","Idioma","mostrar bandeiras emoji","usar o código FIFA de três letras","URL de subscrição do calendário:","Copiar URL","Subscrever","Exemplos de jogos no calendário","Selecione equipas ou ative uma regra.","Ainda não há jogos para estas definições.","Copiado","aumentar","diminuir"],
  "pt-BR": ["Assinatura de calendário personalizada","código-fonte","fontes de dados","Times favoritos","Filtrar times…","Grandes jogos","os dois times estão classificados entre os primeiros","pelas probabilidades de vencer o torneio","os 32 jogos eliminatórios","estreias em casa dos 3 países-sede","Jogos equilibrados","as probabilidades de vitória de cada time diferem em","pontos percentuais","Opções","Idioma","mostrar bandeiras emoji","usar o código FIFA de três letras","URL de assinatura do seu calendário:","Copiar URL","Assinar","Exemplos de jogos no calendário","Selecione times ou ative uma regra.","Ainda não há jogos para estas configurações.","Copiado","aumentar","diminuir"],
  de: ["Benutzerdefiniertes Kalenderabonnement","Quellcode","Datenquellen","Lieblingsteams","Teams filtern…","Topspiele","beide Teams gehören zu den besten","nach ihren Chancen auf den Turniersieg","alle 32 K.-o.-Spiele","Heimauftakt der 3 Gastgeberländer","Ausgeglichene Spiele","die Siegchancen beider Teams liegen innerhalb von","Prozentpunkten","Optionen","Sprache","Emoji-Flaggen anzeigen","dreistelligen FIFA-Ländercode verwenden","Deine Kalender-Abonnement-URL:","URL kopieren","Abonnieren","Beispielspiele im Kalender","Wähle Teams aus oder aktiviere eine Regel.","Noch keine Spiele für diese Einstellungen.","Kopiert","erhöhen","verringern"],
  nl: ["Aangepast kalenderabonnement","broncode","gegevensbronnen","Favoriete teams","Teams filteren…","Topwedstrijden","beide teams staan in de top","op basis van hun kans om het toernooi te winnen","alle 32 knock-outwedstrijden","thuisopeners van de 3 gastlanden","Gelijkwaardige wedstrijden","de winstkansen van beide teams liggen binnen","procentpunten","Opties","Taal","emoji-vlaggen tonen","drieletterige FIFA-landcode gebruiken","URL van je kalenderabonnement:","URL kopiëren","Abonneren","Voorbeeldwedstrijden in de kalender","Selecteer teams of schakel een regel in.","Nog geen wedstrijden voor deze instellingen.","Gekopieerd","verhogen","verlagen"],
  nb: ["Tilpasset kalenderabonnement","kildekode","datakilder","Favorittlag","Filtrer lag…","Storkamper","begge lag er rangert blant de","etter sannsynlighet for å vinne turneringen","alle 32 sluttspillkamper","hjemmeåpningene til de 3 vertslandene","Jevne kamper","vinnersjansene til hvert lag er innenfor","prosentpoeng","Alternativer","Språk","vis emoji-flagg","bruk FIFA-landkode på tre bokstaver","URL for kalenderabonnementet ditt:","Kopier URL","Abonner","Eksempelkamper i kalenderen","Velg lag eller aktiver en regel.","Ingen kamper for disse innstillingene ennå.","Kopiert","øk","reduser"],
};

const uiKeys = ["subtitle","sourceCode","sourceData","favourites","filterTeams","bigGames","rankBefore","rankAfter","knockout","openers","competitiveGames","competitiveBefore","percentagePoints","options","language","flags","code","subscriptionUrl","copyUrl","subscribe","examples","selectPrompt","noMatches","copied","increase","decrease"];
